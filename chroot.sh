...
echo "------------------------------------------------"
echo "Setting time and timezone..."
echo "------------------------------------------------"
...
echo "------------------------------------------------"
echo "Applying hostname and hosts file"
echo "------------------------------------------------"
...
echo "------------------------------------------------"
echo "Install boot image and configuring GRUB..."
echo "------------------------------------------------"
...
echo "------------------------------------------------"
echo "Configuring network... (Please ignore the errors about bus)"
echo "------------------------------------------------"
# Enable NetworkManager (ignore the error)
systemctl enable --now NetworkManager

echo "------------------------------------------------"
echo "Configuring users and sudoers"
echo "------------------------------------------------"
# Config sudoers
...
echo "------------------------------------------------"
echo "Configuring pacman... (Maybe takes about five minutes)"
echo "------------------------------------------------"
# Configure pacman
...
echo "------------------------------------------------"
echo "Installing necessary packages for Xorg and some others necesscities..."
echo "------------------------------------------------"
